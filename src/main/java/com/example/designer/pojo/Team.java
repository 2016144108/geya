...
public class Team {
	...
	public Team(int tid, int mid, int uid, String tname, String tmajor, int tnum, String tintro, String tdate,
			String tschool, String tpic, User user) {
		this.tid = tid;
		this.mid = mid;
		this.uid = uid;
		this.tname = tname;
	...
	public String toString() {
		return "Team [tid=" + tid + ", mid=" + mid + ", uid=" + uid + ", tname=" + tname + ", tmajor=" + tmajor
