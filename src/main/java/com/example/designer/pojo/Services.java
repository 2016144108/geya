...
public class Services {
	...
	public Services(int sid, int uid, int tid, int mid, String sname, String spic, int snum, String sintro,
			String smajor, String sstime, String setime, String sctime, int sread, int sservice, int sgood, int sbad,
			int ssave, String stelephone, String sfile, String sstate, ArrayList<String> scontent, com.example.designer.pojo.TeamSci team,
			int status) {
		this.sid = sid;
		this.uid = uid;
		this.tid = tid;
	...
	public String toString() {
		return "Services [sid=" + sid + ", uid=" + uid + ", tid=" + tid + ", mid=" + mid + ", sname=" + sname
				+ ", spic=" + spic + ", snum=" + snum + ", sintro=" + sintro + ", smajor=" + smajor + ", sstime="
				+ sstime + ", setime=" + setime + ", sctime=" + sctime + ", sread=" + sread + ", sservice=" + sservice
				+ ", sgood=" + sgood + ", sbad=" + sbad + ", ssave=" + ssave + ", stelephone=" + stelephone + ", sfile="
				+ sfile + ", sstate=" + sstate + ", scontent=" + scontent + ", team=" + team + ", status=" + status
				+ "]";
	}
}
