...
$('body').on("click",".send",function(){
	...
	if((sname!=""&&sname!=null)&&(uid!=""&&uid!=null)&&(stelephone!=""&&stelephone!=null)&&(sintro!=""&&sintro!=null)){
		$.ajax({
			url : "../createscience?sname="+sname+"&tid="+tid+"&uid="+uid+"&stelephone="+stelephone+"&mid="+mid+"&smajor="+smajor+"&sintro="+sintro,
			dataType : "json",
			async : false,
			success : function(result) {
				layui.use('layer', function(){
...
$('body').on("click",".reset",function(){
	window.location.href="sciencecreate.html";
})
