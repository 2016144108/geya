			...
			for(var i=0;i<result.data.length;i++){
				...
				<div class="layui-col-md6">
                    <div id="" class="box">
                        ...
                        <span>`+result.data[i].tschool+`</span>
                        <span>`+result.data[i].tstatus+`</span>
                        <span>专业领域：`+result.data[i].tmajor+`</span>
                        <p>简介：`+result.data[i].tintro+`</p>
                    </div>
                </div>`;
			}
			$('#teacher_choose').html(htmltext);
			}
		}
	});
});
